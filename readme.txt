...
Tags: fonts, webfonts, live, customizer, custom fonts, google fonts, websafe fonts
...
Heroic Webfonts allows you to customize your site via the in-built WordPress theme customizer. Use websafe fonts or webfonts from the google font library. There are default fonts the plugin supports, which can be overridden by a supporting theme and you can add your own fonts with custom selectors and styles.
...
3. In Themes>Customize there will be a new option for Heroic Webfonts.
...
A filter hook called 'ht_webfonts_themefonts' is used to load your default theme fonts onto a blank array, the loaded array must then be returned by the filter function.
